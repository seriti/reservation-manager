...
class CashType extends Table 
{
    
    //configure
    public function setup($param = []) 
    {
        $param = ['row_name'=>'Cash Type','col_label'=>'name'];
        parent::setup($param);
        ...
        $this->addTableCol(array('id'=>'tax_code','type'=>'STRING','title'=>'Tax code','required'=>false));
        $this->addTableCol(array('id'=>'tax_value','type'=>'DECIMAL','title'=>'Tax value','required'=>false));
